...
export default function App() {
  ...
  return (
    <div ClassName="App">
      ...
      <Routes>
        <Route path="/dashboard" element={<Categories category={category} setCategory={setCategory} />} />
        <Route path="/fruits" element={<Fruits mango={mango} setMango={setMango} vegetable={vegetable} setVegetable={setVegetable} />} />
        <Route path="/fruits/:id" element={<Fruit />} />
        <Route path="/vegetables/:id" element={<Vegetable />} />
        <Route path="/rice" element={<Rice dal={dal} setDal={setDal} rice={rice} setRice={setRice} atta={atta} setAtta={setAtta} />} />
        <Route path="/rice/:id" element={<RiceCont />} />
        <Route path="/dal/:id" element={<DalCont />} />
        <Route path="/atta/:id" element={<AttaCont />} />
        <Route path="/oil" element={<Oil oil={oil} setOil={setOil} masala={masala} setMasala={setMasala} sauce={sauce} setSauce={setSauce} />} />
        <Route path="/oil/:id" element={<OilCont />} />
        <Route path="/masala/:id" element={<MasalaCont />} />
        <Route path="/sauce/:id" element={<SauceCont />} />
        <Route path="/egg" element={<Eggs egg={egg} setEgg={setEgg} fish={fish} setFish={setFish} chicken={chicken} setChicken={setChicken} mutton={mutton} setMutton={setMutton} />} />
        <Route path="/egg/:id" element={<EggCont />} />
        <Route path="/fish/:id" element={<FishCont />} />
        <Route path="/chicken/:id" element={<ChickenCont />} />
        <Route path="/mutton/:id" element={<MuttonCont />} />
        <Route path="/household" element={<Household />} />
        <Route path="/tea" element={<Tea tea={tea} setTea={setTea} coffee={coffee} setCoffee={setCoffee} />} />
        <Route path="/tea/:id" element={<TeaCont />} />
        <Route path="/coffee/:id" element={<CoffeeCont />} />
        <Route path="/drinks" element={<Drinks drink={drink} setDrink={setDrink} juice={juice} setJuice={setJuice} />} />
        <Route path="/drinks/:id" element={<DrinksCont />} />
        <Route path="/juice/:id" element={<JuiceCont />} />
      </Routes>
    </div>
